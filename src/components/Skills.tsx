...
const softSkills = [
  ...
  { name: 'Organizing', icon: FaChartLine, color: '#8B5CF6', level: 85 },
  { name: 'Management', icon: FaCode, color: '#3B82F6', level: 70 },
...
const SkillBar = ({ skill }: { skill: typeof technicalSkills[0] }) => {
  ...
  return (
    <div className="mb-4 md:mb-6 p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 hover:shadow-lg transition-all duration-300 hover:scale-[1.35]">
